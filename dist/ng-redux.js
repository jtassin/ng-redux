(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('babel-runtime/helpers/toConsumableArray'), require('babel-runtime/core-js/object/keys'), require('babel-runtime/helpers/defineProperty'), require('babel-runtime/core-js/object/assign'), require('babel-runtime/helpers/typeof')) :
	typeof define === 'function' && define.amd ? define(['babel-runtime/helpers/toConsumableArray', 'babel-runtime/core-js/object/keys', 'babel-runtime/helpers/defineProperty', 'babel-runtime/core-js/object/assign', 'babel-runtime/helpers/typeof'], factory) :
	(global.NgRedux = factory(global._toConsumableArray,global._Object$keys,global._defineProperty,global._Object$assign,global._typeof));
}(this, (function (_toConsumableArray,_Object$keys,_defineProperty,_Object$assign,_typeof) { 'use strict';
...
function digestMiddleware($rootScope, debounceConfig) {
  ...
  if (debounceConfig && debounceConfig.wait && debounceConfig.wait > 0) {
    debouncedFunction = index$5($rootScope.$evalAsync, debounceConfig.wait, { maxWait: debounceConfig.maxWait });
  }
 ...
 * of values.
 */
var objectToString$5 = objectProto$6.toString;
...
function isSymbol$1(value) {
  return typeof value == 'symbol' ||
    (isObjectLike$4(value) && objectToString$5.call(value) == symbolTag$1);
}
...
var typeIs = index$6(function (type, val) {
